package com.rzandkotlingit.propreferences
...
public class ProPreferences(val builder: Builder) {
    ...
    class Builder {
        ...
        fun withDefaultPrefs(argDefaultPrefs: Boolean): Builder {
